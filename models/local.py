...
class LocalModel(bd.Model):
    ...
    canchitas = bd.relationship('CanchitaModel',lazy=True,backref='canchas')
    ...
    # 'subquery' => es igual que joined pero por detras usa una subquery para jalar los datos del hijo
